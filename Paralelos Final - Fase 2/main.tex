...
Para cada tamaño del problema $N$, se utiliza el tiempo promedio $\bar{t}$ obtenido
en las Tablas \ref{tab:times_omp} y \ref{tab:times_cuda} como tiempo paralelo $T_{par}$.
...
\paragraph{Eficiencia (OpenMP).}
Para OpenMP, la eficiencia se define como:
\[
E(N) = \frac{S(N)}{p}
\]
